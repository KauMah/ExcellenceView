...
public class InteractiveView extends JFrame implements IInteractiveView, ActionListener {
  ...
  // the readonly model
  private ExcellenceAnimationOperations model;
   ...
   */
  public InteractiveView(ExcellenceAnimationOperations m, int s) {
    if (m == null) {
  ...
  @Override
  public void setListener(ControllerType listener) {
